...
class Raise_Charity_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'raise_charity';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'raise-charity' ), $i ),
...
// Initialize.
$raise_charity_footer_widgets = new Raise_Charity_Footer_Widgets();
